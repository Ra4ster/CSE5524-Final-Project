...
### Output:
```bash
(venv) rose0@fedora:~/Projects/Project_Pandora/CSE5524-Final-Project$ python lens1_analysis.py
[DEBUG] There are 1141 rows in PTL_CV_Dataset.xlsx
Processing dataset and extracting features...
/home/rose0/Projects/Project_Pandora/CSE5524-Final-Project/lens1.py:197: RuntimeWarning: When min_distance < 1, peak_local_max acts as finding image > max(threshold_abs, threshold_rel * max(image)).
...
[RESULT] Elongation vs. Tortuosity (Z) Correlation: -0.0298
[RESULT] Junction Density vs. Fiber Radius Correlation: -0.7215

Calculating Model-Level Harris Statistics...
Exporting results to Excel...
[RESULT] Successfully saved both sheets to Lens1_Results.xlsx
```
...
```bash
(venv) rose0@fedora:~/Projects/Project_Pandora/CSE5524-Final-Project$ python lens3.py
[DEBUG] There are 1141 rows in PTL_CV_Dataset.xlsx
Running Lens 3 Covariance Tracking (Calculating drifts)...
/home/rose0/Projects/Project_Pandora/CSE5524-Final-Project/venv/lib64/python3.14/site-packages/scipy/_lib/_util.py:1136: RuntimeWarning: logm result may be inaccurate, approximate err = 3.367981782420916e-13
  return f(*arrays, *other_args, **kwargs)

--- Dynamic Threshold set to: 0.2355 ---
...
[Model_0032] Drift Variance: 0.3918 | Porosity Variance: 0.007794 | Label: Heterogeneous
[Model_0033] Drift Variance: 0.2988 | Porosity Variance: 0.041666 | Label: Heterogeneous
...
[Model_0036] Drift Variance: 0.2628 | Porosity Variance: 0.057663 | Label: Heterogeneous
...
/home/rose0/Projects/Project_Pandora/CSE5524-Final-Project/lens3.py:110: UserWarning: FigureCanvasAgg is non-interactive, and thus cannot be shown
  plt.show()
Would you like to save the drift to Excel? (y/n): y
```
...
```bash
(venv) rose0@fedora:~/Projects/Project_Pandora/CSE5524-Final-Project$ python lens3_analysis.py
...
Would you like to save the unified results to Excel? (y/n): y
[RESULT] Successfully saved to Unified_Lens3_Results.xlsx
```
